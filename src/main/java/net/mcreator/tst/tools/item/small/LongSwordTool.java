package net.mcreator.scc.tools.item.small;
...
public class LongSwordTool extends ToolItem {
  ...
  public LongSwordTool(Properties properties, ToolDefinition toolDefinition) {
